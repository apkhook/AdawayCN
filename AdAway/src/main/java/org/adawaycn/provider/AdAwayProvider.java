...
package org.adawaycn.provider;

import java.util.Arrays;

import org.adawaycn.provider.*;
import org.adawaycn.provider.AdAwayContract;
import org.adawaycn.provider.AdAwayContract.Blacklist;
import org.adawaycn.provider.AdAwayContract.HostsSources;
import org.adawaycn.provider.AdAwayContract.RedirectionList;
import org.adawaycn.provider.AdAwayContract.Whitelist;
import org.adawaycn.provider.AdAwayDatabase;
import org.adawaycn.provider.AdAwayDatabase.Tables;
...
public class AdAwayProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        final String authority = org.adawaycn.provider.AdAwayContract.CONTENT_AUTHORITY;

        // Hosts sources
        matcher.addURI(authority, org.adawaycn.provider.AdAwayContract.PATH_HOSTS_SOURCES, HOSTS_SOURCES);
        matcher.addURI(authority, org.adawaycn.provider.AdAwayContract.PATH_HOSTS_SOURCES + "/#", HOSTS_SOURCES_ID);

        // Whitelist
        matcher.addURI(authority, org.adawaycn.provider.AdAwayContract.PATH_WHITELIST, WHITELIST);
        matcher.addURI(authority, org.adawaycn.provider.AdAwayContract.PATH_WHITELIST + "/#", WHITELIST_ID);

        // Blacklist
        matcher.addURI(authority, org.adawaycn.provider.AdAwayContract.PATH_BLACKLIST, BLACKLIST);
        matcher.addURI(authority, org.adawaycn.provider.AdAwayContract.PATH_BLACKLIST + "/#", BLACKLIST_ID);

        // Redirection list
        matcher.addURI(authority, org.adawaycn.provider.AdAwayContract.PATH_REDIRECTION_LIST, REDIRECTION_LIST);

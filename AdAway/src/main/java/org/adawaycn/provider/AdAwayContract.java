...
public class AdAwayContract {
    ...
    public static final String CONTENT_AUTHORITY = "org.adawaycn";
    ...
    public static class HostsSources implements HostsSourcesColumns, BaseColumns {
         ...
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.adawaycn.hostssources";

        /**
         * Use if a single item is returned
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.adawaycn.hostssources";
    ...
    public static class Whitelist implements WhitelistColumns, BaseColumns {
         ...
         * Use if multiple items get returned
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.adawaycn.whitelist";

        /**
         * Use if a single item is returned
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.adawaycn.whitelist";
    ...
    public static class Blacklist implements BlacklistColumns, BaseColumns {
         ...
         * Use if multiple items get returned
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.adawaycn.blacklist";

        /**
         * Use if a single item is returned
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.adawaycn.blacklist";
    ...
    public static class RedirectionList implements RedirectionListColumns, BaseColumns {
         ...
         * Use if multiple items get returned
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.adawaycn.redirectionlist";

        /**
         * Use if a single item is returned
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.adawaycn.redirectionlist";

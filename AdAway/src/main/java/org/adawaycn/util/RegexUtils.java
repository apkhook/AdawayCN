...
public class RegexUtils {
    ...
    static public boolean isValidHostname(String input) {
        ...
        try {
            ...
            org.adawaycn.util.Log.e(Constants.TAG, "Error in isValidHostname", e);
    ...
    static public boolean isValidIPv4(String input) {
        ...
        try {
            ...
            org.adawaycn.util.Log.e(Constants.TAG, "Error in isValidIPv4", e);
            // workaround for some devices that throws jni exceptions: just accept everything
            return true;
        }
    }
    ...
    static public boolean isValidIPv6(String input) {
        ...
        try {
            ...
            org.adawaycn.util.Log.e(Constants.TAG, "Error in isValidIPv6", e);
            // workaround for some devices that throws jni exceptions: just accept everything
            return true;
        }
    }
    ...
    static public boolean isValidIP(String input) {
        org.adawaycn.util.Log.d(Constants.TAG, "input: " + input);
        org.adawaycn.util.Log.d(Constants.TAG, "isvalidipv4: " + isValidIPv4(input));
        org.adawaycn.util.Log.d(Constants.TAG, "isvalidipv6: " + isValidIPv6(input));
    ...
    static public String getTcpdumpHostname(String input) {
        ...
        try {
            if (mTcpdumpHostnameMatcher.find()) {
                ...
                org.adawaycn.util.Log.d(Constants.TAG, "Does not find: " + input);
                return null;
            }
        } catch (Exception e) {

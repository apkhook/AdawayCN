...
import org.adawaycn.util.CheckboxCursorAdapter;
...
public class BlacklistFragment extends SherlockListFragment implements
    ...
    private org.adawaycn.util.CheckboxCursorAdapter mAdapter;
    ...
    private void menuDeleteEntry(AdapterContextMenuInfo info) {
        ...
        org.adawaycn.provider.ProviderHelper.deleteBlacklistItem(mActivity, mCurrentRowId);
    }
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (org.adawaycn.util.RegexUtils.isValidHostname(input)) {
                            org.adawaycn.provider.ProviderHelper.updateBlacklistItemHostname(mActivity, mCurrentRowId,
                                    input);
                        } else {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new org.adawaycn.util.CheckboxCursorAdapter(mActivity, R.layout.checkbox_list_entry, null,

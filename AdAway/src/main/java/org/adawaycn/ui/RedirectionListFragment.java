...
import org.adawaycn.provider.ProviderHelper;
import org.adawaycn.util.Constants;
import org.adawaycn.util.RedirectionCursorAdapter;
import org.adawaycn.util.RegexUtils;
...
public class RedirectionListFragment extends SherlockListFragment implements
    ...
    private org.adawaycn.util.RedirectionCursorAdapter mAdapter;
    ...
    private void menuDeleteEntry(AdapterContextMenuInfo info) {
        ...
        org.adawaycn.provider.ProviderHelper.deleteRedirectionListItem(mActivity, mCurrentRowId);
    }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (org.adawaycn.util.RegexUtils.isValidHostname(hostname)) {
                            if (org.adawaycn.util.RegexUtils.isValidIP(ip)) {
                                org.adawaycn.provider.ProviderHelper.updateRedirectionListItemHostnameAndIp(mActivity,
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (cBox != null) {
            if (cBox.isChecked()) {
                ...
                org.adawaycn.provider.ProviderHelper.updateRedirectionListItemEnabled(mActivity, mCurrentRowId, false);
            } else {
                cBox.setChecked(true);
                org.adawaycn.provider.ProviderHelper.updateRedirectionListItemEnabled(mActivity, mCurrentRowId, true);
            }
        } else {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new org.adawaycn.util.RedirectionCursorAdapter(mActivity, R.layout.checkbox_list_two_entry, null,
